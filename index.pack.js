  ...
  _createClass(App, [{
    ...
    value: function handleChange(id) {
      ...
      this.setState(function (prevState) {
        var updatedTodos = prevState.todoState.map(function (todo) {
          if (todo.id === id) {
            console.log("todo id: ", todo.id);
            console.log("conpleted before: ", todo.comleted);
            todo.completed = !todo.completed;
            console.log("completed after: ", todo.completed);
          }
          console.log(todo);
          return todo;
        });
    ...
    value: function render() {
      ...
      var todoItems = this.state.todoState.map(function (item) {
